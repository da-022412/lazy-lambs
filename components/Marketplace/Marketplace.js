...
const CONTENT = {
    ...
    copy: [
        ...
        {
            text: 'The project is also designed with sustainability and long-term utility. <b style="color:ffea0e;>50% of the profits</b> from every item sold in the marketplace will be stored on a locked, secure wallet, that will be used as an expansion fund guided by the community. ',
        },
        {
