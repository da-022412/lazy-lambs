...
const CONTENT = {
    ...
    copy: [
        ...
        {
            text: 'We will donate <span style="color:#ffea0e"><b>10% of net profits</b></span> for the entirety of the project (including aftermarket sales)</b> to a charity or non-profit organization selected by majority vote from our members.',
        },
    ],
    img: Img,
};
