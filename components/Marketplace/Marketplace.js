...
const CONTENT = {
    ...
    copy: [
        {
            text: 'Our vision is to open play-to-eran racing game and marketplace where anyone can buy, sell, or trade digital vehicles in a fully immersive and interactive 3D environment. All transactions are recorded in the Ethereum blockchain using smart contracts to verify and manage the ownership and history of the items.',
        },
        {
